...
class MobileSettingsPanel extends StatefulWidget {
  final double width;
  const MobileSettingsPanel({super.key, required this.width});

  @override
  State<MobileSettingsPanel> createState() => _MobileSettingsPanelState();
}

class _MobileSettingsPanelState extends State<MobileSettingsPanel> {
