...
import 'features/utils/presentation/getx/controllers/utils_controller.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final UtitlityController controller = Get.put<UtitlityController>(UtitlityController());
    return ScreenUtilInit(
      // Dynamic sizes across all screen sizes
      builder: (_, child) {
        return Obx(
          () => GetMaterialApp(
